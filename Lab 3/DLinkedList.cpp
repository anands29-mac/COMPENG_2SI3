...
DLinkedList<E>::DLinkedList()
{
	...
	head = new DNode<E>(e, NULL, NULL);
	tail = new DNode<E>(e, NULL, NULL);
...
void DLinkedList<E>::addFirst(const E &e)
{
	...
	DNode<E>* newElement = new DNode<E>(e, head->next, head);
...
void DLinkedList<E>::addLast(const E &e)
{
	...
	DNode<E>* newElement = new DNode<E>(e, tail, tail->prev);
