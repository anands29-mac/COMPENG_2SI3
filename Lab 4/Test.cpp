...
#define SIZE20 20
#define SIZE50 50
#define TOTAL_ASSERT_COUNT 371
#define TOTAL_TEST_CASES 21
...
// 26 assertion counts
void testInsert20isInTreewithModel()
{
	bool result = true;

	cout << "TEST: testInsert20isInTreewithModel" << endl;
	...
	for(int i = 0; i < SIZE20; i++)
	{
		...
		TreeUnderTest->insert(tempPos);
		TreeModel->insert(tempPos);
	}
	...
	for(int i = 0; i < 26; i++)
	{
		...
		expected = TreeModel->isInTree(target);
...
// 26 assertion counts
void testInsert50isInTreewithModel()
{
	bool result = true;

	cout << "TEST: testInsert50isInTreewithModel" << endl;
	bool expected, actual;
	objPos tempPos;
	createNewTrees();
...
void testInsert20IsLeafCheckwithModel() {

	bool result = true;

	cout << "TEST: testInsert20IsLeafCheckwithModel" << endl;
	bool expected, actual;
	objPos tempPos;
	createNewTrees();
	...
	for(int i = 0; i < 26; i++)
	{
		...
		expected = TreeModel->isLeaf(target);
...
// 26 assertion counts  (a - z)
void testInsert50IsLeafCheckwithModel() {

	bool result = true;

	cout << "TEST: testInsert50IsLeafCheckwithModel" << endl;
	bool expected, actual;
	objPos tempPos;
	createNewTrees();
...
// 26 assertion counts  (a - z)
void testInsert20Remove10IsInTreeCheckwithModel()
{
	bool result = true;

	cout << "TEST: testInsert20Remove10IsInTreeCheckwithModel" << endl;
	bool expected, actual;
	objPos tempPos;
	createNewTrees();
	...
	{
		tempPos = generateRandomPos();
		TreeUnderTest->remove(tempPos);
		TreeModel->remove(tempPos);
	}
	
	for(int i = 0; i < 26; i++)
	{
		tempPos.setPF(i + 'a');
		actual = TreeUnderTest->isInTree(tempPos);
		expected = TreeModel->isInTree(tempPos);
...
// 26 assertion counts  (a - z)
void testInsert50Remove25IsInTreeCheckwithModel()
{
	bool result = true;

	cout << "TEST: testInsert50Remove25IsInTreeCheckwithModel" << endl;
	bool expected, actual;
	objPos tempPos;
	createNewTrees();
...
// 1 assertion call
void testInsert100FindGreaterThen98CheckwithModel() {

	bool result = true;

	cout << "TEST: testInsert100FindGreaterThen98CheckwithModel" << endl;
	bool expected, actual;
	objPos tempPos;
	createNewTrees();
	...
	actual = TreeUnderTest->findGreater(THRESHOLD);
	expected = TreeModel->findGreater(THRESHOLD);
...
bool runAllTests(int argc, char const *argv[]) {
	...
	testInsert20isInTreewithModel(); // 26
	testInsert50isInTreewithModel(); // 26

	testInsert20IsLeafCheckwithModel();       // Random 20 Elements Test against Model  // 26
	testInsert50IsLeafCheckwithModel();       // Random 50 Elements Test against Model  // 26
	...
	testInsert20Remove10IsInTreeCheckwithModel();   // 26
	testInsert50Remove25IsInTreeCheckwithModel();   // 26
	...
	testInsert100FindGreaterThen98CheckwithModel();	  // 1
...
objPos generateRandomPos()
{
	...
	tempPos.setX(rand() % 100);
	tempPos.setY(rand() % 100);        
    randCandidate = rand() % 26 + 'A';  
    if(rand() % 2) randCandidate += 32; 
    tempPos.setPF((char)randCandidate); 
    tempPos.setNum(rand() % 100);   
